...
step_1 = PrimitiveStep(primitive=index.get_primitive('d3m.primitives.feature_selection.rffeatures.Rffeatures'))
step_1.add_argument(name='inputs', argument_type=ArgumentType.CONTAINER, data_reference='steps.0.produce')
step_1.add_output('produce')
step_1.add_hyperparameter(name='num_features', argument_type=ArgumentType.VALUE,data=63)
