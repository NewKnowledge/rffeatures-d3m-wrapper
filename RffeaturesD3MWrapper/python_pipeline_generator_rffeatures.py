...
step_3.add_hyperparameter(name='only_numeric_cols', argument_type=ArgumentType.VALUE,data=True)
step_3.add_hyperparameter(name='proportion_of_features', argument_type=ArgumentType.VALUE,data=1.0)
